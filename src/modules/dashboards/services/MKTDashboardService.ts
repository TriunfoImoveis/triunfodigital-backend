  ...
  public async execute(): Promise<IRequestMKTDashboardDTO> {
    ...
    const mktSales = sales_sellers.map(sale => {
      ...
      return {
        ...
        'CLIENTE VENDEDOR - ORIGEM': sale.client_seller && sale.client_seller.origin ? sale.client_seller.origin.name : '',
        ...
        'CLIENTE COMPRADOR - ORIGEM': sale.client_buyer && sale.client_buyer.origin ? sale.client_buyer.origin.name : '',
