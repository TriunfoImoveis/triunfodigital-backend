...
class ExportSaleService {
  ...
  public async execute({
    ...
    name,
    status,
  }: IRequestRepository): Promise<IResponseDTO | undefined> {
    ...
    const workSheetColumnNames = [
      ...
      {
        header: 'VALOR DO SINAL',
        key: 'value_signal',
        width: 15,
        style: { numFmt: '"R$"#,##0.00;[Red]-"R$"#,##0.00' },
      },
      {
        header: 'DATA PAG. SINAL',
        key: 'pay_date_signal',
        width: 15,
        style: { numFmt: 'dd/mm/yyyy' },
      },
      ...
      {
        header: 'CONTATO CONTRUTORA - TELEFONE',
        key: 'builder_contact_phone',
        width: 30,
      },
      {
        header: 'CONTATO CONTRUTORA - EMAIL',
        key: 'builder_contact_email',
        width: 30,
      },
      {
        header: 'CLIENTE VENDEDOR - NOME',
        key: 'client_seller_name',
        width: 20,
      },
      {
        header: 'CLIENTE VENDEDOR - DATA NASCIMENTO',
        key: 'client_seller_datebirth',
        width: 15,
        style: { numFmt: 'dd/mm/yyyy' },
      },
      {
        header: 'CLIENTE VENDEDOR - EMAIL',
        key: 'client_seller_email',
        width: 20,
      },
      {
        header: 'CLIENTE VENDEDOR - TELEFONE',
        key: 'client_seller_phone',
        width: 20,
      },
      {
        header: 'CLIENTE VENDEDOR - PROFISSAO',
        key: 'client_seller_occupation',
        width: 20,
      },
      {
        header: 'CLIENTE VENDEDOR - ESTADO CIVIL',
        key: 'client_seller_civilStatus',
        width: 20,
      },
      {
        header: 'CLIENTE COMPRADOR - NOME',
        key: 'client_buyer_name',
        width: 20,
      },
      {
        header: 'CLIENTE COMPRADOR - ORIGEM',
        key: 'client_buyer_origin',
        width: 20,
      },
      {
        header: 'CLIENTE COMPRADOR - DATA NASCIMENTO',
        key: 'client_buyer_datebirth',
        width: 15,
        style: { numFmt: 'dd/mm/yyyy' },
      },
      {
        header: 'CLIENTE COMPRADOR - EMAIL',
        key: 'client_buyer_email',
        width: 20,
      },
      {
        header: 'CLIENTE COMPRADOR - TELEFONE',
        key: 'client_buyer_phone',
        width: 20,
      },
      {
        header: 'CLIENTE COMPRADOR - PROFISSAO',
        key: 'client_buyer_occupation',
        width: 20,
      },
      {
        header: 'CLIENTE COMPRADOR - ESTADO CIVIL',
        key: 'client_buyer_civilStatus',
        width: 20,
      },
      ...
      {
        header: '1º PARCELA DT PAG',
        key: 'installment_due_date_0',
        width: 20,
        default: '-------------',
      },
      {
        header: '2º PARCELA',
        key: 'installment_value_1',
        width: 20,
        default: '-------------',
      },
      {
        header: '2º PARCELA DT PAG',
        key: 'installment_due_date_1',
        width: 20,
        default: '-------------',
      },
      {
        header: '3º PARCELA',
        key: 'installment_value_2',
        width: 20,
        default: '-------------',
      },
      {
        header: '3º PARCELA DT PAG',
        key: 'installment_due_date_2',
        width: 20,
        default: '-------------',
      },
      {
        header: '4º PARCELA',
        key: 'installment_value_3',
        width: 20,
        default: '-------------',
      },
      {
        header: '4º PARCELA DT PAG',
        key: 'installment_due_date_3',
        width: 20,
        default: '-------------',
      },
      {
        header: '5º PARCELA',
        key: 'installment_value_4',
        width: 20,
        default: '-------------',
      },
      {
        header: '5º PARCELA DT PAG',
        key: 'installment_due_date_4',
        width: 20,
        default: '-------------',
      },
    ];
    ...
    const data = sales.map(sale => {
      ...
      if (client_seller) {
        ...
        clientSeller_datebirth = date_birth
          ? parseISO(date_birth.toString())
          : null;
      }
      if (client_buyer) {
        const { date_birth } = client_buyer;
        clientBuyer_datebirth = date_birth
          ? parseISO(date_birth.toString())
          : null;
      }
      ...
      installments.forEach((installment, index) => {
        installmentFields = {
          ...installmentFields,
          [`installment_value_${index}`]: numberInBRL(
            Number(installment.value),
          ),
          [`installment_due_date_${index}`]: format(
            parseISO(installment.due_date.toString()),
            'dd/MM/yyyy',
          ),
        };
      });
      ...
      const sales = {
        ...
        pay_date_signal: sale.pay_date_signal
        ...
        client_seller_civilStatus: client_seller
          ? client_seller.civil_status
          : null,
        client_buyer_name: client_buyer ? client_buyer.name : null,
        client_buyer_origin:
          client_buyer && client_buyer.origin ? client_buyer.origin.name : '',
        ...
        client_buyer_civilStatus: client_buyer
          ? client_buyer.civil_status
          : null,
