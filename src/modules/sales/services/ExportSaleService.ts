  ...
  public async execute(): Promise<IResponseDTO | undefined> {
    ...
    const data = sales.map((sale) => {
      ...
      const sales = {
        ...
        client_seller_name: sale.client_seller ? sale.client_seller.name : null,
        client_seller_datebirth: sale.client_seller ? parseISO(sale.client_seller.date_birth.toString()) : null,
        client_seller_email: sale.client_seller ? sale.client_seller.email : null,
        client_seller_phone: sale.client_seller ? sale.client_seller.phone : null,
        client_seller_occupation: sale.client_seller ? sale.client_seller.occupation : null,
        client_seller_civilStatus: sale.client_seller ? sale.client_seller.civil_status : null,
        client_buyer_name: sale.client_buyer.name,
        client_buyer_datebirth: sale.client_buyer.date_birth,
